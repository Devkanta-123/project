        ...
        <table border="0" cellspacing="4" cellpadding="0">
            <tr>
                ...
                <td>
                    ...
                    <asp:LinkButton ID="LinkButtonDelete" runat="server" OnClick="LinkButtonDelete_Click">DEL</asp:LinkButton>
                    <br />
                    <br />
                </td>
            </tr>
            ...
            <tr>
                <td align="right"></td>
                <td>
                    <asp:Button ID="ButtonOK" runat="server" CssClass="btn btn-primary btn-sm"  OnClick="ButtonOK_Click" Text="  OK  " />
