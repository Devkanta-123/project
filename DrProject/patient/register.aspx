...
<body class="hold-transition theme-primary bg-img" style="background-image: url(/images/auth-bg/dr2.jpg)">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0">Register a new Patient</p>							
							</div>
    <form id="form1" runat="server">
        	<div class="p-40">
                ...
                <div class="form-group">
										<div class="input-group mb-3">
											...
											<asp:TextBox ID="fullname" runat="server" placeholder="Full Name"  class="form-control ps-15 bg-transparent" ></asp:TextBox>
                                            &nbsp;&nbsp;
			...
			<div class="input-group mb-3">
                ...
                <asp:TextBox ID="emailid" runat="server"  class="form-control ps-15 bg-transparent" placeholder="Email ID"></asp:TextBox>
				 &nbsp;&nbsp;
           ...
           <span class="input-group-text bg-transparent"><i class="ti-lock"></i></span>
                <asp:TextBox ID="password" runat="server" class="form-control ps-15 bg-transparent" placeholder="Password" TextMode="Password"></asp:TextBox>
				 &nbsp;&nbsp;
			...
			<div class="input-group mb-3">
                ...
                <asp:TextBox ID="address" runat="server"  class="form-control ps-15 bg-transparent" placeholder="Address"></asp:TextBox>
				 &nbsp;&nbsp;
			...
			<div class="input-group mb-3">
               ...
               <asp:TextBox ID="phn" runat="server" class="form-control ps-15 bg-transparent" placeholder="Phone Number" TextMode="Number" ></asp:TextBox>
				 &nbsp;&nbsp;
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="phn" Display="Dynamic" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
             </div>
			</div>
				<div class="row">
										<div class="col-12">
